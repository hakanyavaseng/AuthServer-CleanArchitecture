...
namespace AuthServer.WebAPI.Controllers
{
    ...
    public class RolesController : ControllerBase
    {
        ...
        [HttpGet]
        [AuthorizeDefinition(Menu = AuthorizeDefinitionConsts.Roles, ActionType = ActionType.Reading, Definition = "Get All Roles")]
        ...
        [HttpGet("{roleId}")]
        [AuthorizeDefinition(Menu = AuthorizeDefinitionConsts.Roles, ActionType = ActionType.Reading, Definition = "Get Role By Id")]
        ...
        [HttpPut("{roleName}")]
        [AuthorizeDefinition(Menu = AuthorizeDefinitionConsts.Roles, ActionType = ActionType.Updating, Definition = "Update Role")]
        ...
        [HttpDelete("{roleName}")]
        [AuthorizeDefinition(Menu = AuthorizeDefinitionConsts.Roles, ActionType = ActionType.Deleting, Definition = "Delete Role")]
        ...
        [HttpPost("[action]")]
        [AuthorizeDefinition(Menu = AuthorizeDefinitionConsts.Roles, ActionType = ActionType.Writing, Definition = "Assign Role To User")]
        ...
        [HttpPost("[action]")]
        [AuthorizeDefinition(Menu = AuthorizeDefinitionConsts.Roles, ActionType = ActionType.Writing, Definition = "Assign Role To Endpoint")]
        public async Task<ApiResponse<NoContentDto>> AssignRoleToEndpoint([FromBody] AssignRoleToEndpointDto assignRoleToEndpointDto)
        {
            return await _roleService.AssignRoleToEndpoint(assignRoleToEndpointDto);
        }

        [HttpPost("[action]")]
        public async Task<ApiResponse<NoContentDto>> AssignRoleToEndpoints([FromBody] AssignRoleToEndpointsDto assignRoleToEndpointsDto)
        {
